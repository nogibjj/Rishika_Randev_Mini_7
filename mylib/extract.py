...
def extract(url="https://data.cdc.gov/api/views/8pt5-q6wp/rows.csv?accessType=DOWNLOAD", 
    ...
    df_subset = df.loc[(df["Group"] == "By State") & (df["Time Period Start Date"] == "05/07/2020"), ["Indicator", "Group", "State", "Time Period Start Date", "Time Period End Date", "Value", "High CI"]]
